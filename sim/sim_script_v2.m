...
k_th = 0.05; % gain on PD part of control - makes adaptation harder
k_z = 3;
k_x = 3;

ahat_outer_t0 = [(m+m_p); -c_d];

ahat_in1 = 2*I/l;
ahat_in2 = -2*m_p*l_p/l;

ahat_inner_t0 = [ahat_in1; ahat_in2];
%}
...
x0 = states(1,1);
z0 = states(1,2);
th0 = -atan2(u(1,1)/(m+m_p),u(1,2)/(m+m_p)+g);
